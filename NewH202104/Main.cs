...
namespace Huangbo.AStarPetri.Test
{
    class MainClass
    {
        ...
        static void Main(string[] args)
        {
            ...
            //string fileName = "Chenfig5revised_33";  //The prefix of your input Petri net files.         fileName should be "XXXFigx_111_init.txt" or "XXXFigx_111_matrix.txt".   
            //string fileName = "ChenFig6_111";  //The prefix of your input files. 
            string fileName = "Chen2011Bigchange3_22222";
            //string fileName = "new4x3nobuff_2222";
            //string fileName = "Preliminary_11";
            //string fileName = "Xiong98nobuff_1111";
            //string fileName = "Chenfig6changed3_444";
            //string fileName = "Huang2012fig1_1121";
            ...
            //string fileName = "ChenFig5changed2_44";
            ...
            int[] hMethods = new int[]  { 7 };//所用启发函数h  //the used heuristic function, for example, if you want to use h=0, you input 0 here and if you want to use h=h_H, you input 7 here.
            //h0 = 0;
